...
function up(){
    if(y >= 0){
y = y - block_height;
console.log("height of the block =" + block_height);
console.log("x position of the player = " + x + "y position of the player = " + y);
...
function left(){
    if(x >= 0){
x = x - block_width;
console.log("height of the block =" + block_width);
console.log("x position of the player = " + x + "y position of the player = " + y);
canvas.remove(player_object);
add_player();
    }
